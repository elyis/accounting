...
namespace accounting.Migrations
{
    ...
    [Migration("20230506092544_sale_user")]
    partial class sale_user
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("accounting.src.Models.AmountOfAccountedProduct", b =>
                {
                    b.Property<Guid>("ProductAccountingId")
                        .HasColumnType("uuid");
                    ...
                    b.HasKey("ProductAccountingId", "ProductId");

                    b.HasIndex("ProductId");

                    b.ToTable("AmountOfAccountedProduct");
                });
            ...
            modelBuilder.Entity("accounting.src.Models.ProductAccounting", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");

                    b.Property<float>("CheckPrice")
                        .HasColumnType("real");
            ...
            modelBuilder.Entity("accounting.src.Models.AmountOfAccountedProduct", b =>
                {
                    b.HasOne("accounting.src.Models.ProductAccounting", "ProductAccounting")
                        .WithMany("AccountedProducts")
                        .HasForeignKey("ProductAccountingId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
                    ...
                    b.Navigation("ProductAccounting");
                });
            ...
            modelBuilder.Entity("accounting.src.Models.Product", b =>
                {
                    b.Navigation("AccountedProducts");
            ...
            modelBuilder.Entity("accounting.src.Models.User", b =>
                {
                    ...
                    b.Navigation("ProductAccountings");
                });
